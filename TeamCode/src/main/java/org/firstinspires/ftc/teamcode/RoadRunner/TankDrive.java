...
import org.firstinspires.ftc.teamcode.RoadRunner.Decode.*;
...
public final class TankDrive {
    ...
    public TankDrive(HardwareMap hardwareMap, Pose2d pose) {
        ...
        leftMotors = Collections.singletonList(hardwareMap.get(DcMotorEx.class, "LFM"));
        rightMotors = Collections.singletonList(hardwareMap.get(DcMotorEx.class, "RFM"));
