...
public class SwerveDriveKinematics
    implements Kinematics<org.firstinspires.ftc.teamcode.Swerve.wpilib.kinematics.SwerveModuleState[], org.firstinspires.ftc.teamcode.Swerve.wpilib.kinematics.SwerveModulePosition[]> {
   ...
   *     attainable max velocity. Use the {@link #desaturateWheelSpeeds(org.firstinspires.ftc.teamcode.Swerve.wpilib.kinematics.SwerveModuleState[], double)
   *     DesaturateWheelSpeeds} function to rectify this issue.
   */
  public org.firstinspires.ftc.teamcode.Swerve.wpilib.kinematics.SwerveModuleState[] toSwerveModuleStates(
          org.firstinspires.ftc.teamcode.Swerve.wpilib.kinematics.ChassisSpeeds chassisSpeeds, Translation2d centerOfRotationMeters) {
    org.firstinspires.ftc.teamcode.Swerve.wpilib.kinematics.SwerveModuleState[] moduleStates = new org.firstinspires.ftc.teamcode.Swerve.wpilib.kinematics.SwerveModuleState[m_numModules];

    if (chassisSpeeds.vxMetersPerSecond == 0.0
        && chassisSpeeds.vyMetersPerSecond == 0.0
        && chassisSpeeds.omegaRadiansPerSecond == 0.0) {
      for (int i = 0; i < m_numModules; i++) {
        moduleStates[i] = new org.firstinspires.ftc.teamcode.Swerve.wpilib.kinematics.SwerveModuleState(0.0, m_moduleHeadings[i]);
      }
    ...
    for (int i = 0; i < m_numModules; i++) {
      ...
      moduleStates[i] = new org.firstinspires.ftc.teamcode.Swerve.wpilib.kinematics.SwerveModuleState(speed, angle);
  ...
  /**
   * Performs inverse kinematics. See {@link #toSwerveModuleStates(org.firstinspires.ftc.teamcode.Swerve.wpilib.kinematics.ChassisSpeeds, Translation2d)}
   * toSwerveModuleStates for more information.
   *
   * @param chassisSpeeds The desired chassis speed.
   * @return An array containing the module states.
   */
  public org.firstinspires.ftc.teamcode.Swerve.wpilib.kinematics.SwerveModuleState[] toSwerveModuleStates(org.firstinspires.ftc.teamcode.Swerve.wpilib.kinematics.ChassisSpeeds chassisSpeeds) {
    return toSwerveModuleStates(chassisSpeeds, Translation2d.kZero);
  }

  @Override
  public org.firstinspires.ftc.teamcode.Swerve.wpilib.kinematics.SwerveModuleState[] toWheelSpeeds(org.firstinspires.ftc.teamcode.Swerve.wpilib.kinematics.ChassisSpeeds chassisSpeeds) {
   ...
   */
  @Override
  public org.firstinspires.ftc.teamcode.Swerve.wpilib.kinematics.ChassisSpeeds toChassisSpeeds(org.firstinspires.ftc.teamcode.Swerve.wpilib.kinematics.SwerveModuleState... moduleStates) {
    ...
    for (int i = 0; i < m_numModules; i++) {
      org.firstinspires.ftc.teamcode.Swerve.wpilib.kinematics.SwerveModuleState module = moduleStates[i];
    ...
    return new org.firstinspires.ftc.teamcode.Swerve.wpilib.kinematics.ChassisSpeeds(
   ...
   */
  public Twist2d toTwist2d(org.firstinspires.ftc.teamcode.Swerve.wpilib.kinematics.SwerveModulePosition... moduleDeltas) {
    ...
    for (int i = 0; i < m_numModules; i++) {
      org.firstinspires.ftc.teamcode.Swerve.wpilib.kinematics.SwerveModulePosition module = moduleDeltas[i];
  ...
  @Override
  public Twist2d toTwist2d(org.firstinspires.ftc.teamcode.Swerve.wpilib.kinematics.SwerveModulePosition[] start, org.firstinspires.ftc.teamcode.Swerve.wpilib.kinematics.SwerveModulePosition[] end) {
    if (start.length != end.length) {
      throw new IllegalArgumentException("Inconsistent number of modules!");
    }
    org.firstinspires.ftc.teamcode.Swerve.wpilib.kinematics.SwerveModulePosition[] newPositions = new org.firstinspires.ftc.teamcode.Swerve.wpilib.kinematics.SwerveModulePosition[start.length];
    for (int i = 0; i < start.length; i++) {
      newPositions[i] =
          new org.firstinspires.ftc.teamcode.Swerve.wpilib.kinematics.SwerveModulePosition(end[i].distanceMeters - start[i].distanceMeters, end[i].angle);
    }
  ...
  public static void desaturateWheelSpeeds(
          org.firstinspires.ftc.teamcode.Swerve.wpilib.kinematics.SwerveModuleState[] moduleStates, double attainableMaxSpeedMetersPerSecond) {
    double realMaxSpeed = 0;
    for (org.firstinspires.ftc.teamcode.Swerve.wpilib.kinematics.SwerveModuleState moduleState : moduleStates) {
   ...
   */
  public static void desaturateWheelSpeeds(
      org.firstinspires.ftc.teamcode.Swerve.wpilib.kinematics.SwerveModuleState[] moduleStates,
  ...
  @Override
  public org.firstinspires.ftc.teamcode.Swerve.wpilib.kinematics.SwerveModulePosition[] copy(org.firstinspires.ftc.teamcode.Swerve.wpilib.kinematics.SwerveModulePosition[] positions) {
    org.firstinspires.ftc.teamcode.Swerve.wpilib.kinematics.SwerveModulePosition[] newPositions = new org.firstinspires.ftc.teamcode.Swerve.wpilib.kinematics.SwerveModulePosition[positions.length];
  ...
  @Override
  public void copyInto(org.firstinspires.ftc.teamcode.Swerve.wpilib.kinematics.SwerveModulePosition[] positions, org.firstinspires.ftc.teamcode.Swerve.wpilib.kinematics.SwerveModulePosition[] output) {
  ...
  @Override
  public org.firstinspires.ftc.teamcode.Swerve.wpilib.kinematics.SwerveModulePosition[] interpolate(
          org.firstinspires.ftc.teamcode.Swerve.wpilib.kinematics.SwerveModulePosition[] startValue, org.firstinspires.ftc.teamcode.Swerve.wpilib.kinematics.SwerveModulePosition[] endValue, double t) {
    if (endValue.length != startValue.length) {
      throw new IllegalArgumentException("Inconsistent number of modules!");
    }
    org.firstinspires.ftc.teamcode.Swerve.wpilib.kinematics.SwerveModulePosition[] newPositions = new SwerveModulePosition[startValue.length];
