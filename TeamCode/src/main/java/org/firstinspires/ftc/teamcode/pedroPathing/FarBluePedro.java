...
//            telemetry.addData("Status", pinpoint.odo.getDeviceStatus());
    ...
    public int autonomousPathUpdate() {
        switch (pathState) {
            case 0:
                follower.followPath(Path1, Shooter.maxPower, false);
                setPathState(1);
                break;
            case 1:
                if (!follower.isBusy()) {
                    ...
                    follower.followPath(Path2, Shooter.maxPower, false);
                    setPathState(-1);
                }
                break;
            case 2:
                if (!follower.isBusy()) {
                    follower.followPath(Path3, Shooter.maxPower, true);
                    timer.reset();
                    setPathState(3);
                }
                break;
            case 3:
                if (!follower.isBusy()) {
                    ...
                    if (timer.seconds() > 1) {
                        ...
                        follower.followPath(Path8, Shooter.maxPower, true);
                        setPathState(8);
                    }
                }
                break;
            case 4:
                if (!follower.isBusy()) {
                    ...
                    follower.followPath(Path5, Shooter.maxPower, true);
            ...
            case 5:
                if (!follower.isBusy()) {
                    ...
                    follower.followPath(Path6, Shooter.maxPower,true);
                    setPathState(6);
                }
                break;
            case 6:
                if (!follower.isBusy()) {
                    ...
                    follower.followPath(Path7, Shooter.maxPower, true);
                    setPathState(7);
                }
                break;
            case 7:
            ...
            case 8:
                if (!follower.isBusy()) {
                    follower.followPath(Path9, Shooter.maxPower, true);
                    setPathState(9);
                }
                break;
            case 9:
                if (!follower.isBusy()) {
                    follower.followPath(Path4, Shooter.maxPower, true);
                    setPathState(5);
                }
                break;
        }
