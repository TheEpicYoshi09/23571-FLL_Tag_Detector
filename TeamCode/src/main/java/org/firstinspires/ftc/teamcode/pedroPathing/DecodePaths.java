...
public class DecodePaths {
    ...
    public static final Pose BLUE_FAR_SHOOT_TO_SPIKE3 = new Pose(48.25, 28.5, Math.toRadians(180));
    public static final Pose BLUE_FAR_PICKUP_SPIKE3_PART1 = new Pose(34, 28.5, Math.toRadians(180));
    public static final Pose BLUE_FAR_PICKUP_SPIKE3_PART2 = new Pose(25.5, 28.5, Math.toRadians(180));
