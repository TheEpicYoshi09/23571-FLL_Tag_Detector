...
public class Paths {
    ...
    // Intake 9
    public static Pose P_I9_CP        = new Pose(99.939, 38.5);
    public static Pose P_I9_END       = new Pose(99.264, 38.5);
    public static Pose P_I9_WALL      = new Pose(125, 38.5);
    public static Pose P_I9_RETURN    = new Pose(99.433, 38.5);
