...
//        motorBackRight.setDirection(DcMotor.Direction.REVERSE);
        ...
        shooterPID = new PIDFCoefficients(12, 0, 0, 0.8);
...
//                motorShooterLeft.setVelocity(-3500);
//                motorShooterRight.setVelocity(3500);
            }
            else {
                motorShooterLeft.setPower(0.0);
                motorShooterRight.setPower(0.0);
//                moto;ShooterLeft.setVelocity(0);
//                motorShooterRight.setVelocity(0);
            ...
            if(gamepad2.left_stick_y>0 || gamepad2.left_stick_y<0) {
                motorIntake.setPower(gamepad2.left_stick_y);
            }
            else{
